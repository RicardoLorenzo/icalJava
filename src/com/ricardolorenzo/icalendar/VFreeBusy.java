...
public class VFreeBusy implements Serializable {
    ...
    public void setAttendee(final String mail, final Person att) throws Exception {
        if (mail != null) {
            attendee.put(mail, att);
        }
    }

    public void setOrganizer(final String mail, final Person att) throws Exception {
        if (mail != null) {
